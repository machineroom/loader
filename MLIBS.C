...
****************************************************************************/
/****************************************************************************
* This program MLIB.C provide functions for managing processes and channel  *
...
ChanAlloc(void)
        {
        extern int chanind, chans[30];
        Channel *c;

	chans[chanind] = NOPROCESS;
        return(chans + (chanind++)); /*return pointer to chan*/
        }

/*}}}  */
static  int      chanind = 0;
static  Channel  chans[16];
