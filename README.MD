...
April 2020. Early WX9020 results are encouraging - main image scan time only, no render:
...
System | 1st | 2nd
-------|-----|----
Axel cube 65 T425 | 2.32s | 8.16s
13  nodes | 7.03s|37.27s
36  nodes | 4.97s | 19.59s
121 nodes | 2.95s | 7.88s
Pi3       | 0.19s | 1.00s

121 nodes is _just_ the fastest operation T425 system in the world (woot). 
